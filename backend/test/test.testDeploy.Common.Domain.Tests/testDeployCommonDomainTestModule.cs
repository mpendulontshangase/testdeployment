...
using test.testDeploy.Tests.DependencyInjection;
using Shesha;
...
namespace test.testDeploy.Common.Tests
{
    [DependsOn(
    ...
    public class testDeployCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public testDeployCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
