...
namespace test.testDeploy.Common.Authorization
{
    /// <summary>
    /// testDeploy Permission checker
    /// </summary>
    public class testDeployPermissionChecker : ICustomPermissionChecker, ItestDeployPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public testDeployPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
